...
export default function ChatCard({
  ...
  return (
    <>
      <div className="flex gap-10 mt-10 mb-8 items-center">
        <div className="flex flex-col items-center gap-3">
          <img
            src={profileImg}
            className="w-[243px] h-[243px] rounded-full object-cover object-center"
          />
          <Button
        ...
        <div className="w-[284px] h-[317px] rounded-2xl py-3.5 px-[18px]">
          ...
          <div className="my-8 flex flex-col gap-3.5">
