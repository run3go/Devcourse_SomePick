...
export default function Postcard() {
  return (
    <div
      className="flex items-stretch w-[1080px] h-[250px]
    ...
    >
      <div className="flex-1 p-4 flex flex-col">
        <div className="space-y-2">
          ...
          <div className="flex items-center">
            ...
            <span className="text-[#969696] ml-2">· 2025-06-07</span>
          </div>

          {/* 제목 */}
          <h2 className="text-lg font-semibold">안녕하세요 이현우에요</h2>
      ...
      <div className="p-4 flex-shrink-0 self-center">
        <img src={image} alt="Post" className="w-[144px] h-[144px] object-cover rounded-lg" />
      </div>
    </div>
  );
}
